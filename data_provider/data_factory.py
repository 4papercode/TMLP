from data_provider.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_M4, PSMSegLoader, \
    MSLSegLoader, SMAPSegLoader, SMDSegLoader, SWATSegLoader, UEAloader, Dataset_Custom_Hour, Dataset_WECC
...
data_dict = {
    ...
    'SWAT': SWATSegLoader,
    'UEA': UEAloader,
    'TGCN': Dataset_Custom_Hour,
    'WECC': Dataset_WECC,
}


def data_provider(args, flag):
    print(f"data provider dataset name is {args.data}")
