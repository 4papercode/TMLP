...
if __name__ == '__main__':
    ...
    parser.add_argument('--align_lambda1', type=float, default=0.0, help='MMD alignment weight for F_GT vs memory_features')
    parser.add_argument('--align_lambda2', type=float, default=0.0, help='MMD alignment weight for F_mm vs memory_features')
    ...
    parser.add_argument('--ba_name', type=str, default='CISO',
                        help='target BA name for WECC dataset (e.g. CISO, BPAT)')
    parser.add_argument('--wecc_data_root', type=str,
                        default='../cleaned_data_16-24',
                        help='folder containing *_cleaned_historical_data.csv files')
    parser.add_argument('--similarity_path', type=str,
                        default='utils/wecc_similarity.npy',
                        help='path to pre-computed Pearson similarity matrix')
    parser.add_argument('--neighbors_path', type=str,
                        default='utils/wecc_neighbors.json',
                        help='path to pre-computed first-order neighbor index lists')
    parser.add_argument('--ba_names_path', type=str,
                        default='utils/wecc_ba_names.json',
                        help='path to ordered BA name list')
    parser.add_argument('--adj_path', type=str,
                        default='utils/wecc_adj.csv',
                        help='path to 28x28 binary adjacency matrix CSV (index = BA names)')
    parser.add_argument('--year', type=int, default=None,
                        help='if set, restrict data to this calendar year (e.g. 2020)')
    parser.add_argument('--use_topology', type=str2bool, default=False,
                        help='enable Topology-Augmented Learner (TAL) branch')
    parser.add_argument('--pi_root_1', type=str, default=None,
                        help='path to the first PI folder, e.g. PI_type_1/')

    parser.add_argument('--pi_root_2', type=str, default=None,
                        help='path to the second PI folder, e.g. PI_type_2/')
