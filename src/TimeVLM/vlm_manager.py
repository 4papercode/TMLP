...
class VLMManager:
    ...
    def _init_clip(self):
        ...
        try:
            ...
            self.processor = CLIPProcessor.from_pretrained(CLIP_ARCH, local_files_only=True, backend="torchvision")
    ...
    def _process_clip_inputs(self, B, images, prompts):
        encoding = self.processor(images=images, text=prompts, return_tensors="pt", do_rescale=False).to(self.device)
